...
import { Area, AreaChart, ResponsiveContainer, Line, LineChart as RechartsLineChart } from 'recharts';
...
export default function WaveformDisplay({ isPlaying, showVolumeAutomation, showSpeedAutomation }: WaveformDisplayProps) {
